...
def download_file(file_url, dest_dir):
    ...
    if f"{os.path.splitext(filename)[1]}" == ".gz":
...
def main():
    ...
    download_file("https://github.com/wpilibsuite/raspbian-toolchain/releases/download/v1.3.0/Raspbian9-Linux-Toolchain-6.3.0.tar.gz", "build")
    subprocess.run(["make"])
