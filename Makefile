...
LDFLAGS := -Lbuild/example-cpp-2019.3.1/cpp-multiCameraServer/lib -lwpilibc -lwpiHal -lcameraserver -lntcore -lcscore -lopencv_calib3d -lopencv_features2d -lopencv_imgproc -lopencv_core -lopencv_highgui -lopencv_imgcodecs -lopencv_videoio -lwpiutil -Wl,--unresolved-symbols=ignore-in-shared-libs
